...
import 'package:start_with_flutter_again/Charly/utils/app_layout.dart';
import 'package:start_with_flutter_again/Charly/utils/app_styles.dart';
import 'package:start_with_flutter_again/Charly/widgets/thick_container.dart';
...
class _TicketsTestState extends State<TicketsTest> {
  ...
  _onTapVideo() async {
    final controller = /* _controller */ VideoPlayerController.network(
        "https://cmsdimayor.s3.amazonaws.com/golesfecha13dim.mp4");
    // "https://www.youtube.com/watch?v=gh7WzMTsMoQ");
